...
"""
LCPDF Decryptor — Decrypt Readium LCP-protected PDF files.
...
def main():
    ...
    tk.Label(hdr, text="// export LCP-protected PDF", font=_FONT_SM, bg=_BG, fg=_DIM).pack(side=tk.LEFT, padx=(10, 0))
    ...
    log.info("LCPDF to PDF initialized — profiles 1.0 through 2.9 loaded")
